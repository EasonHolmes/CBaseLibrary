...
-keep public class * extends androidx.lifecycle.Lifecycle
...
#-------------------------------------------定制化区域----------------------------------------------
#bean的包路径（如下：）
-keep class com.shijieyun.kb.app.model.entity.** { *; }
-keep class com.shijieyun.kb.app.http.entity.** { *; }
#viewdatabinding
#-keep class  com.shijieyun.kb.app.databinding.* {*;}
